...
// shadcn-style Button. Uses shadcn semantic tokens: `primary` for the
// brand action color, `destructive` for dangerous actions. The legacy
// `--accent` token is a *neutral hover surface* in shadcn's model, so it
// must NOT be used as a button fill.
