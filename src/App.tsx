    ...
    <>
      ...
      {route === "views" && (
        <button
          ...
          className="fixed right-6 top-3 z-40 inline-flex h-9 w-9 items-center justify-center rounded-md text-muted-foreground transition-colors duration-150 hover:bg-muted hover:text-foreground"
        >
          <svg
            width="18"
            height="18"
